...
2026-09-08 应用更新至 `990d404`。首页无需登录浏览和筛选课程，个人操作仍受会话保护；页面明确显示邮件暂停及采集时间。74 项测试、门户与首页浏览器回归通过；生产工作流、上线后手机/桌面浏览和权限检查通过。具体范围与剩余限制见 [公开浏览发布记录](PUBLIC_BROWSING_2026_09_08.md)。以下为此前批次记录。

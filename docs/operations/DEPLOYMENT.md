...
事实范围：部署样例和启动代码已核对；当前生产实例使用 `49.233.248.86`、域名 `buaaboya.top`，并已完成 HTTPS、Nginx、systemd、公开/管理边界和新版本发布验收。2026-09-04 已观察到真实课程抓取和邮件 outbox 投递；2026-09-07 发布时当前课程周期暂无可选课程，邮件、Telegram 和自动选课配置未修改，长期稳定性继续观察。
